...
LANGUAGES = {'am': 'Amharic', 'ar': 'Arabic', 'eu': 'Basque', 'bn': 'Bengali', 'en-GB': 'English (UK)',
       ...
       'hu': 'Hungarian', 'is': 'Icelandic', 'id': 'Indonesian', 'it': 'Italian', 'ja': 'Japanese', 'kn': 'Kannada',
       'ko': 'Korean', 'lv': 'Latvian', 'lt': 'Lithuanian', 'ms': 'Malay', 'ml': 'Malayalam', 'mr': 'Marathi',
       'no': 'Norwegian', 'pl': 'Polish', 'pt-PT': 'Portuguese (Portugal)', 'ro': 'Romanian', 'ru': 'Russian',
       'sr': 'Serbian', 'zh-CN': 'Chinese (PRC)', 'sk': 'Slovak', 'sl': 'Slovenian', 'es': 'Spanish', 'sw': 'Swahili',
